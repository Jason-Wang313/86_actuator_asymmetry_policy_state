...
Honest strongest claim: `Treat actuator asymmetry as latent policy state rather than calibration noise.` is a plausible branch-structured mechanism for robot adaptation and control, supported by synthetic multi-seed diagnostic evidence and hostile-prior-work-aware positioning.
